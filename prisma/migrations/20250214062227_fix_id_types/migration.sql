/*
  ...
  - You are about to alter the column `id` on the `abstracts` table. The data in that column could be lost. The data in that column will be cast from `String` to `Int`.
  ...
  - You are about to alter the column `id` on the `other_identifiers` table. The data in that column could be lost. The data in that column will be cast from `String` to `Int`.
  ...
  - You are about to alter the column `id` on the `other_titles` table. The data in that column could be lost. The data in that column will be cast from `String` to `Int`.
  ...
  - You are about to alter the column `id` on the `sources` table. The data in that column could be lost. The data in that column will be cast from `String` to `Int`.
